    ...
    <div className=" max-w-[940px]  h-[600px] border-4 border-blue-900 mx-auto relative top-[-80px] shadow-xl scale-75 p-[30px]">
      ...
      <div className="border border-red-600 max-w-[300px] mx-auto my-5 p-8">
        ...
        <select
          ...
          name="designation"
          required
          class="block appearance-auto w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
        >
        ...
        <button className="bg-red-300 ml-5 rounded-lg p-1" onClick={formHandle}>
          Register Me
        </button>
      </div>
    </div>
